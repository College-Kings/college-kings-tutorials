screen fight_preparation_tutorial():
    ...
    vbox:
        ...
        button:
            ...
            action Show("confirm", message="Are you sure you want to hide the tutorial?", yes_action=[Hide("confirm"), AddToSet(persistent.hidden_tutorials, "fight_preparation_tutorial")])
